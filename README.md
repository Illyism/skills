...
npx skills add Illyism/skills --skill blitz-copy

# Install all skills
npx skills add Illyism/skills

# List available skills
npx skills add Illyism/skills --list
```
...
Each skill is a folder with a `SKILL.md` following the [Agent Skills spec](https://agentskills.io):
